...
async function open_modal_dialog(content, actions, close_event) {
  ...
  btn1.style = "color: #fff;background-color: #1E90FF;border-color: #28a745;font-weight: 400;border: 1px solid transparent;padding: .375rem .75rem;font-size: 1rem;line-height: 1.5;border-radius: .25rem;transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;"
  btn1.textContent = content.button1_text

  let btn2 = document.createElement("BUTTON")
  btn2.style = "color: #1E90FF;text-decoration: underline #1E90FF;border-color: #dc3545;font-weight: 400;border: 1px solid transparent;padding: .375rem .75rem;font-size: 1rem;line-height: 1.5;border-radius: .25rem;margin-left: 2px;background: transparent !important;"
